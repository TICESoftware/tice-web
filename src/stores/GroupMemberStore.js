...
export const useGroupMemberStore = defineStore('group', () => {
...
function updateLocation(group, envelope, container) {
...
function updateUsername(userId, group) {
...
return { updateLocation, updateUsername, filterLocations, deleteLocation, getUsername, getColor, getInitials }
})